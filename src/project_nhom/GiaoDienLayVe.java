...
public class GiaoDienLayVe extends JFrame {
	...
	public GiaoDienLayVe() {
		...
		lblNewLabel.setBounds(356, 56, 461, 85);
		panel_2.add(lblNewLabel);
		
		Component rigidArea = Box.createRigidArea(new Dimension(20, 20));
		rigidArea.setBounds(0, 10, 1204, 41);
		panel_2.add(rigidArea);
		
		Component rigidArea_4 = Box.createRigidArea(new Dimension(20, 20));
		rigidArea_4.setBounds(0, 32, 354, 109);
		panel_2.add(rigidArea_4);
		
		Component rigidArea_5 = Box.createRigidArea(new Dimension(20, 20));
		rigidArea_5.setBounds(821, 32, 383, 109);
		...
		panel_4.setBounds(10, 5, 1191, 61);
		panel_3.add(panel_4);
		...
		panel_5.setBounds(20, 76, 1159, 618);
		panel_3.add(panel_5);
		...
		panel_6.setBounds(51, 132, 1058, 484);
		panel_5.add(panel_6);
		...
		btnNewButton_1.setBounds(491, 769, 241, 53);
